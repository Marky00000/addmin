  ...
  <div class="container">
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        ...
        <div class="row">
            <div class="col-lg-6 d-none d-lg-block bg-login-image" style="background-image: url('https://plataforma.unipolidgo.edu.mx/moodle/pluginfile.php/147773/course/overviewfiles/requerimientosw.gif');"></div>
            <div class="col-lg-6">
            <div class="p-5">
